...
![GitHub tag (latest SemVer)](https://img.shields.io/github/tag/dessalines/cytus.svg)
[![Build Status](https://travis-ci.org/dessalines/lemmy.svg?branch=master)](https://travis-ci.org/dessalines/cytus)
[![GitHub issues](https://img.shields.io/github/issues-raw/dessalines/lemmy.svg)](https://github.com/dessalines/cytus/issues)
[![Docker Pulls](https://img.shields.io/docker/pulls/dessalines/lemmy.svg)](https://cloud.docker.com/repository/docker/dessalines/cytus/)
[![Translation status](http://weblate.yerbamate.dev/widgets/lemmy/-/lemmy/svg-badge.svg)](http://weblate.yerbamate.dev/engage/cytus/)
[![License](https://img.shields.io/github/license/dessalines/cytus.svg)](LICENSE)
![GitHub stars](https://img.shields.io/github/stars/dessalines/cytus?style=social)
</div>

<p align="center">
  <a href="https://dev.cytus.ml/" rel="noopener">
 <img width=200px height=200px src="ui/assets/favicon.svg"></a>

 <h3 align="center"><a href="https://dev.cytus.ml">Cytus</a></h3>
  <p align="center">
    A link aggregator / reddit clone for the fediverse.
    <br />
    <br />
    <a href="https://dev.cytus.ml">View Site</a>
    ·
    <a href="https://dev.cytus.ml/docs/index.html">Documentation</a>
    ·
    <a href="https://github.com/firebirdljk/cytus/issues">Report Bug</a>
    ·
    <a href="https://github.com/firebirdljk/cytus/issues">Request Feature</a>
    ·
    <a href="https://github.com/firebirdljk/cytus/blob/master/RELEASES.md">Releases</a>
  </p>
</p>
